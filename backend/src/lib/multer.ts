...
export const marketplaceUploadImageExtensions = ['.jpg', '.jpeg', '.png', '.gif', '.svg'] as const;
export const marketplaceUploadDocumentExtensions = ['.pdf', '.docx', '.xlsx', '.txt'] as const;
