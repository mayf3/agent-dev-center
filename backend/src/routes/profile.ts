...
const updateHrInfoSchema = z.object({
  body: z.object({
    internalRole: z.enum(['cto', 'pm', 'developer', 'backend_developer', 'frontend_developer', 'mobile_developer', 'miniapp_developer', 'game_developer', 'efficiency_manager', 'lobster_partner', 'tester', 'security', 'ops', 'qa']).optional().nullable(),
    department: z.string().trim().max(100).optional().nullable(),
    title: z.string().trim().max(100).optional().nullable(),
