...
function mapUserRole(internalRole: string | null | undefined, role: string): string | null {
  ...
  const mapping: Record<string, string[]> = {
    cto: ['cto', 'admin'],
    admin: ['cto', 'admin'],
    backend_developer: ['backend_developer', 'developer'],
    frontend_developer: ['frontend_developer', 'developer'],
    mobile_developer: ['mobile_developer', 'developer'],
    miniapp_developer: ['miniapp_developer', 'developer'],
    game_developer: ['game_developer', 'developer'],
    developer: ['developer'],
    tester: ['tester'],
    security: ['security'],
    ops: ['ops'],
